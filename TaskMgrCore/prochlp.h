...
EXTERN_C M_API void MFroceKillProcessUser();
EXTERN_C M_API void MKillProcessUser(BOOL ask);
...
EXTERN_C M_API NTSTATUS MRusemeProcessNt(DWORD dwPId, HANDLE handle);
